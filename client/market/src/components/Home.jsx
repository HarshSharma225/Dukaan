    ...
    <div className="bg-black min-h-screen text-white font-sans">
      ...
      <section className="bg-[#f3e0d3] text-black px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div onClick={handleClick} className="bg-yellow-400 rounded-xl flex justify-center items-center p-6">
            <img
              src={image6}
              alt="Product 1"
          ...
          <div onClick={handleClick} className="bg-gray-800 rounded-xl flex justify-center items-center p-6">
            <img
              src={image3}
              alt="Product 2"
              className="rounded-md"
      ...
      <section className="bg-[#f3e0d3] px-8 py-10 text-center">
        ...
        <p className="text-gray-700 max-w-xl mx-auto">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Saddo cuiamed
          tempor incididunt utaboret et dolore magna aliqua.
        </p>
      </section>
